...
export const api = {
  ...
  signInWithGoogle: (input: { credential: string; locale: "pt-BR" | "en" }) =>
  ...
  updateProfile: (input: Partial<Pick<PlayerProfile, "displayName" | "preferredFoot" | "preferredPosition" | "bio">>) =>
  ...
  completeMatch: (input: { id: string; homeScore: number; awayScore: number; eventLog: Match["eventLog"] }) =>
